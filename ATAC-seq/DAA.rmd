...
Objects created:
- `count_list` - contains all processed count objects for each cell line
- `d492.counts`, `hmle.counts` - individual count objects (for original naming compatibility)
- `granges_list` - GRanges objects for each cell line  
- `bam_list` - BAM file paths for each cell line
